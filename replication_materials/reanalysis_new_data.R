...
stargazer(s51, s52, s53, s54,  type="text",
          ...
          out = "s5_reanalysis_merge_fix_new_data.txt")
...
stargazer(s61, s62, s63, s64, s65,  type="text",
          ...
          out = "s6_reanalysis_merge_fix_new_data.txt")
...
stargazer(s71, s72, s73, s74, s75,  type="text",
          ...
          out = "s7_reanalysis_merge_fix_new_data.txt")
...
stargazer(s51, s52, s53, s54,  type="html",
          ...
          model.numbers = FALSE,
          title = "Table TK. Replication of Table S5 without Merge Failure",
          out = "s5_reanalysis_merge_fix_new_data.htm")
...
stargazer(s61, s62, s63, s64, s65,  type="html",
          ...
          covariate.labels=c("COVID-19 period", "Floyd period", 
                             ...
                             "Precipitation", "Temperature", "AQI", "OpenTable", "Spatial lag"),
          title = "Table TK. Replication of Table S6 Violent crime without Merge Failure",
          out = "s6_reanalysis_merge_fix_new_data.htm")
...
stargazer(s71, s72, s73, s74, s75,  type="html",
          ...
          covariate.labels=c("COVID-19 period", "Floyd period", 
                             ...
                             "Precipitation", "Temperature", "AQI", "OpenTable", "Spatial lag"),
          title = "Table TK. Replication of Table S7 - Property crime without Merge Failure",
          out = "s7_reanalysis_merge_fix_new_data.htm")
...
stargazer(vcn_61, vcn_62, vcn_63, vcn_64, vcn_65, vcn_66,  type="text",
          ...
          out = "s6_reanalysis_new_vars_vcn_new_data.txt")
...
stargazer(vcn_61, vcn_62, vcn_63, vcn_64, vcn_65, vcn_66,  type="html",
          ...
          covariate.labels=c("COVID-19 period", "Floyd period", 
                             ...
                             "Precipitation", "Temperature", "AQI", "OpenTable", "Spatial lag"),
          title = "Table TK. Reanalysis of Table S6 using corrected violent crime metric",
          out = "s6_reanalysis_new_vars_vcn_new_data.htm")
...
stargazer(vcns_61, vcns_62, vcns_63, vcns_64, vcns_65, vcns_66,  type="text",
          ...
          out = "s6_reanalysis_new_vars_vcns_new_data.txt")
...
stargazer(s_vcns_61, s_vcns_62, s_vcns_63, s_vcns_64, s_vcns_65, s_vcns_66,  type="text",
          ...
          out = "s6_reanalysis_new_vars_std_vcns_new_data.txt")
...
stargazer(vcns_61, vcns_62, vcns_63, vcns_64, vcns_65, vcns_66,  type="html",
          ...
          covariate.labels=c("COVID-19 period", "Floyd period", 
                             ...
                             "Precipitation", "Temperature", "AQI", "OpenTable", "Spatial lag"),
          title = "Table TK. Reanalysis of Table S6 using broader violent crime metric including simple assault",
          out = "s6_reanalysis_new_vars_vcns_new_data.htm")
...
stargazer(s_vcns_61, s_vcns_62, s_vcns_63, s_vcns_64, s_vcns_65, s_vcns_66,  type="html",
          ...
          covariate.labels=c("COVID-19 period", "Floyd period", 
                             ...
                             "Precipitation", "Temperature", "AQI", "OpenTable", "Spatial lag"),
          title = "Table TK. Reanalysis of Table S6 using broader violent crime metric including simple assault, standardized coef.",
          out = "s6_reanalysis_new_vars_std_vcns_new_data.htm")
